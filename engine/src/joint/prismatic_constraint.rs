...
use crate::math::{Angular, Point, Vector, DIM, SPATIAL_DIM};
...
impl<N: RealField, Handle: BodyHandle> PrismaticConstraint<N, Handle> {
    ...
    /// body parts that're restricted to a single translation along the 'axis1' axis.
    /// Expressed in the local coordinates frame of 'b1'.
    pub fn new(
        b1: BodyPartHandle<Handle>,
        b2: BodyPartHandle<Handle>,
        anchor1: Point<N>,
